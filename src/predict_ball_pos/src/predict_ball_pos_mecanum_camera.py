                ...
                if ball_pos[0] < 13:
                    ...
                    if len(ball_trajectory) > 2:
                        ...
                        if esti_ball_trajectory:
                            ...
                            target_point = BTE.get_robot_move_point()

                            if target_point.shape[0]:
                                array2data.data = target_point
                            ...
                            # print("landing_point = ",BTE.landing_point)
                else:
